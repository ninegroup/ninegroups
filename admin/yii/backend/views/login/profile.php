										...
										<div class="col-xs-12 col-sm-3 center">
											<div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="" src="uploads/<?php echo $img?>" />
												</span>
												...
												<div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
													<div class="inline position-relative">
														<a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
															...
															&nbsp;
															<span class="white"><?php echo $name;?>'s</span>
														</a>
											...
											<div class="profile-user-info profile-user-info-striped">
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="username"><?php echo  $content['u_name']?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														...
														<span class="editable" id="country"><?php echo $content['u_tel']?></span>
													</div>
												</div>
												...
												<div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="signup"><?php echo $content['u_email']?></span>
													</div>
												</div>
												 ...
												 <div class="profile-info-row">
													...
													<div class="profile-info-value">
														<span class="editable" id="login"><?php echo $content['u_time']?></span>
													</div>
												</div>
...
<![endif]-->
		...
		<script src="../views/assets/js/jquery.gritter.min.js"></script>
		...
		<script src="../views/assets/js/jquery.hotkeys.min.js"></script>
		<script src="../views/assets/js/bootstrap-wysiwyg.min.js"></script>
		...
		<script src="../views/assets/js/x-editable/bootstrap-editable.min.js"></script>
		<script src="../views/assets/js/x-editable/ace-editable.min.js"></script>
