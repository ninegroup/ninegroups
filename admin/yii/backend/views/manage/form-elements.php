...
<?php 
	$form = ActiveForm::begin([
		...
		'action'=>'index.php?r=manage/info',
		'method'=>'post',
	]) 
?>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
								...
								<form class="form-horizontal" role="form" action="index.php?r=manage/info" method="post" enctype="multipart/form-data">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-1">用户名 </label>

										<div class="col-sm-9">
											<input type="text" name='name' placeholder="Username" class="col-xs-10 col-sm-5" />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="password"name='pwd' placeholder="Password" class="col-xs-10 col-sm-5" />
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-tags">是否通过</label>
									...
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-field-4">文件</label>

										<div class="" style="width:380px;margin-left:280px;">
									...
									<div class="clearfix form-actions">
										<div class="col-md-offset-3 col-md-9">
											...
											<input class="btn btn-info" type="submit" value="sumbit" >
