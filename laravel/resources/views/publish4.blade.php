...
<link href="http://staticnew.mayi.com/resourcesWeb/css/flow_chart.css" rel="stylesheet"  type="text/css">
	<div class='one_workflow yes_person'>
		...
		<div class="homes-con">
			...
			<form autocomplete="off" name="priceform" action="/room/publish/priceinfoSubmit"  method = "post" >
				...
				<ul class="price-set">
					...
					<li>
						<div class="dayPrice">
							...
							<input class="LargePriceInput" type="text" id="deposit" name="deposit" value="" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onafterpaste="this.value=this.value.replace(/[^\d.]/g,'')" autocomplete="off"/>元
					...
					<li>
						<div class="dayPrice">
                            ...
                            <div class="PayRule small-PayRule">                                           
                                <p>付款：订单确认后，支付总房价的
                                	<select class="SmallPriceSelect" name="payrule">
                                ...
                                <div class="tk-box">
                                     <span class="tk-box-tt">退款：</span>
                                     <label class="PriceLabel"><input type="radio" value="0"  name="notSupportRefund" class="PriceRadio refundRadio" >支持退款</label>
                                     <label class="PriceLabel"><input type="radio" value="1"  name="notSupportRefund" class="PriceRadio refundRadio" checked> 不支持退款</label>
                                </div>
                                <div class="rule-info" id="refundRuleDiv">
                                	<p>房客在入住日前
                                    	<select class="SmallPriceSelect" name="refunddays" id="refunddaysFirst" onchange="refunddayChange(1);">
                                    	...
                                    	</select>天18:00之前取消订单，预付订金全部退还。
                                    </p>
                                    <p>房客在入住日前
                                    	<select class="SmallPriceSelect" id="refunddaysTwo" onchange="refunddayChange(2);">
                                            <option  value="1">1</option>
                                            <option  value="2">2</option>
                                            <option  value="3">3</option>
                                           	<option  value="7">7</option>
                                            <option  value="15">15</option>
                                            <option  value="30">30</option>
                                    	</select>天18:00之后，入住日的18:00之前取消订单，从预付订金中扣除入住第一天的房租。
                                    </p>
                                    <p>房客入住日期的18：00之后默认为入住，并扣除当天房租。若入住后提前退房。则房东从线上预付订金中扣除退房次日的房租。
                                    </p>
                                </div>
                                <div class="rule-info" id="notRefundRuleDiv"><p class="btk-info">房客一旦支付，取消订单概不退款。</p></div>
                            </div>
                        </div>
					</li>
				</div>
