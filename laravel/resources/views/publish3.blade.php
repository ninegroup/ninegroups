...
<link href="http://staticnew.mayi.com/resourcesWeb/css/flow_chart.css" rel="stylesheet"  type="text/css">
	...
	<div class="homes-con">
		...
		<form autocomplete="off" name="uploadFileForm" action="/room/publish/imageinfoSubmit" method="post" enctype="multipart/form-data">
		<input type="hidden" name="roomId" id="roomId" value="850454908" />
