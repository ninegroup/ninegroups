	                ...
	                <div class="showinfo">
	                    ...
	                    <div class="head_pop">
	                        <div class="pop_column">
								<p class="textCt"><a href="{{URL::route('Index/userList')}}">个人信息</a></p>
...
<link href="http://staticnew.mayi.com/resourcesWeb/css/flow_chart.css" rel="stylesheet"  type="text/css">
	...
	<div class="homes-con" style="margin-top:0px;">
		...
		<div class="homes">
				...
				<dd>
					<label><input type="text" maxlength="22" minlength="5" class="larLargeInput clickhs fl hasPlaceholder" name="h_city" value=""></label>
				</dd>
			</dl>
			<dl class="homesDescribe clearfix">
				<dt><span class="fr">是否地下室：</span><span class="wordNumber"></span></dt>
				<dd>
					<select name="h_message" id="" class="largeSelect">
			...
			<dl class="homesDescribe clearfix">
				...
				<dd>
					<label><input type="text" maxlength="22" minlength="5" class="larLargeInput clickhs fl hasPlaceholder" name="h_people" value=""></label>
                    <span class="lineh28">人</span>
				</dd>
			</dl>
			<dl class="homesDescribe clearfix">
				<dt><span class="fr">同类房源：</span><em class="notNull"></em></dt>
				<dd>
					<label><input type="text" maxlength="22" minlength="5" class="larLargeInput clickhs fl hasPlaceholder" name="h_state" value=""></label>
                    <span class="lineh28">户型、装修、陈设、价格相同的房间（含此房源在内）</span>
				</dd>
			</dl>
			<dl class="homesDescribe clearfix">
			...
			<dl class="homesDescribe clearfix">
				...
				<dd>
					<input type="checkbox" value="暖气" name="h_mating[]">暖气&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value="WIFI" name="h_mating[]">WIFI&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value="浴霸" name="h_mating[]">浴霸&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value="热水" name="h_mating[]">热水&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value="电视" name="h_mating[]">电视&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value="空调" name="h_mating[]">空调&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value="冰箱" name="h_mating[]">冰箱&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<input type="checkbox" value="门禁" name="h_mating[]">门禁&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</dd>
			</dl>

			<dl class="homesDescribe clearfix">
				<dt>
					<span class="fr">服务</span>
					<span class="wordNumber"></span>
				</dt>
				<dd>
					<input type="checkbox" value="免费停车" name="h_serve[]"/>免费停车&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value="接机" name="h_serve[]"/>接机&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<input type="checkbox" value="行李寄存" name="h_serve[]"/>行李寄存&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				</dd>
			</dl>
			<dl class="homesDescribe clearfix">
				<dt>
					<span class="fr">房间类型</span>
					<span class="wordNumber"></span>
				</dt>
				<dd>
					<select name="h_type" id="" class="largeSelect">
			...
			<dl class="homesDescribe clearfix">
				<dt>
					<span class="fr">户型</span>
					<span class="wordNumber"></span>
				</dt>
				<dd>
					<select name="h_h" id="" class="largeSelect">
			...
			<dl class="homesDescribe clearfix">
				<dt><span class="fr">每日价格：</span><em class="notNull"></em></dt>
				<dd>
